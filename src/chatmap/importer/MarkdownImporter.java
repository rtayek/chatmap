...
public final class MarkdownImporter {
    ...
    public static final String SOURCE = "markdown";
    ...
    public ImportedChat importMarkdown(String markdown, String fallbackTitle, String importedAt) {
        ...
        Chat chat = new Chat(0, null, SOURCE, deriveTitle(markdown, fallbackTitle),
                null, null, importedAt, false);
        Message message = new Message(0, 0, UNKNOWN_ROLE, markdown, 0, null, null);
